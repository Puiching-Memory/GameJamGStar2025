...
import { CardFactory } from '../data/CardFactory.js';
import { CardEffect } from '../gameplay/CardEffect.js';
...
import { LogSystem } from '../ui/LogSystem.js';
...
import { BuffRenderer } from '../ui/BuffRenderer.js';
import { CardAnimation } from '../animation/CardAnimation.js';
import { DragDrop } from '../interaction/DragDrop.js';
import { Tooltip } from '../ui/Tooltip.js';
import { GitHistory } from '../core/GitHistory.js';
import { GitGraphRenderer } from '../ui/GitGraphRenderer.js';
...
export class Game {
    constructor() {
        ...
        // 音效系统
        this.audioSystem = new AudioSystem({ enabled: true, volume: 0.5 });
    ...
    endTurn() {
        ...
        // 播放回合结束音效
        this.audioSystem.play(SoundEffects.TURN_END);
        
        // 记录事件
        this.commentator.recordEvent('turn_end', { player: 'player' });
        this.commentator.recordEvent('turn_start', { player: 'opponent' });
    ...
    startPlayerTurn() {
        ...
        // 播放回合开始音效
        this.audioSystem.play(SoundEffects.TURN_START);
        
        // 记录事件
        this.commentator.recordEvent('turn_end', { player: 'opponent' });
        this.commentator.recordEvent('turn_start', { player: 'player' });
    ...
    checkGameOver() {
        ...
        if (winner === 'opponent') {
            ...
            this.audioSystem.play(SoundEffects.DEFEAT);
            this.commentator.recordEvent('game_over', { winner: 'opponent' });
            this.gameOver('opponent');
        } else if (winner === 'player') {
            this.logSystem.addLog('你获胜了！恭喜！', 'game');
            this.audioSystem.play(SoundEffects.VICTORY);
            this.commentator.recordEvent('game_over', { winner: 'player' });
